...
// Должен быть массив нод, так как при хранении указателя необходимо все время бегать в далекую память,
//(в кеше) не храниться, а масиив прога могла бы просто держать в кеше
// ноды должны быть в одном списке ( если хранить ноду в массиве и следущей ноды нет указатель нулл)
// плюс лишние аллокации
